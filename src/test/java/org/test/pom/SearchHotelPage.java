...
public class SearchHotelPage extends LibGlobal {
	...
	public void searchHotelPage(String location, String hotels, String roomType, String roomNos, String checkInDate, String checkOutDate, String adultRoom, String childRoom) {
		...
		type(getDate(), checkInDate);
		type(getDate1(), checkOutDate);
